...
public class FacebookSignInProvider implements SignInProvider {
    ...
    public void reloadUserInfo() {
        ...
        parameters.putString("fields", "name,picture.type(large), first_name, last_name, email, gender");
        ...
        try {
            ...
            emailId = null != json.getString("email")? json.getString("email") : "sriram.priyanka@gmail.com";
